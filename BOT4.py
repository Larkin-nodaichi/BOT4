...
def setup_kaggle():
    files.upload()  # Prompt for kaggle.json file upload
    !mkdir ~/.kaggle
...
def main():
    ...
    option = st.sidebar.radio("Choose a Phase", ["Download Dataset", "Load Data", "Preprocess Data", "Build Models", "Evaluate Model", "Prototype"])

    if option == "Download Dataset":
        st.header("Download Dataset")
        st.write("Setting up Kaggle API and downloading the dataset...")
        download_dataset()
